...
class MarketMaker:
    ...
    def update_demands(self):
        self.df.append(self.fund.demand(self.pt))
        self.dc.append(self.chart.demand(self.pt))
    ...
    def update_price(self):
        mu = 0.01
        self.update_demands()
        a = self.get_attractiveness(self.pf, self.xt[-1], self.pt[-1])
...
MM = MarketMaker(0.5, 0.5, 0.5, 0.5)